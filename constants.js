 ...
 const FEMALE_PRODUCTS = '/products/female';
 const MALE_KIDS_PRODUCTS = '/products/male/kids';
 const FEMALE_KIDS_PRODUCTS = '/products/female/kids';
 const ACCESSORIES_PRODUCTS = '/products/accessories';
 const PRODUCTS_STORE = '/products/store';
 const PRODUCT_IMAGES = '/products/images';
 const PRODUCT_SLIDER_IMAGES = '/products/sliderImages';
 ...
 const ADVERTISEMENT_IMAGE = '/databaseEntryForm/save-image';
 ...
 module.exports = {
     ...
     MALE_KIDS_PRODUCTS: MALE_KIDS_PRODUCTS,
     FEMALE_KIDS_PRODUCTS: FEMALE_KIDS_PRODUCTS,
     ACCESSORIES_PRODUCTS: ACCESSORIES_PRODUCTS,
     PRODUCTS_STORE: PRODUCTS_STORE,
     PRODUCT_IMAGES: PRODUCT_IMAGES,
     PRODUCT_SLIDER_IMAGES: PRODUCT_SLIDER_IMAGES,
     PRODUCT_ADVERT_IMAGES: PRODUCT_ADVERT_IMAGES,
     HOT_OR_NOT: HOT_OR_NOT,
     PARTNERS_FOR_DATAPAGE: PARTNERS_FOR_DATAPAGE,
     UPDATE_USER: UPDATE_USER,
     DASHBOARD: DASHBOARD,
     DATABASE_ENTRY_FORM: DATABASE_ENTRY_FORM,
